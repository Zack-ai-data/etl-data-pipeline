...
This assessment aims to evaluate a junior data engineer's proficiency in 
...
1.	SQL  Query:
2.	Documentation: User guide for setting up, running the script.

This assessment tests SQL data transformation.
Submission expected to be a link git repository.
